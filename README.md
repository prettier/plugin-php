...
| `maxChainCallExpressionCountPHP`       | `3` | Controls how many chained expressions are allowed in one line. `printWidth` will still break chains into separate lines if they exceed set width.                                            |
